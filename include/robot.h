...
*/
#define LIFT_MIDDLE_RIGHT_MOTOR 5
/**  
...
*/
#define LIFT_MIDDLE_LEFT_MOTOR 7
/**  
* De finition for the top left lift motor
*/
#define LIFT_TOP_LEFT_MOTOR 10

#define PINCER_LEFT_MOTOR 9
#define PINCER_RIGHT_MOTOR 8
...
inline void setPincerMotors(int pincer){
  motorSet(PINCER_LEFT_MOTOR, pincer);
  motorSet(PINCER_RIGHT_MOTOR, -pincer);
}
